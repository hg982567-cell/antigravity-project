...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary:
        "bg-blue-600 hover:bg-blue-700 text-white shadow-sm focus:ring-blue-500 dark:focus:ring-offset-slate-900",
      secondary:
      ...
      outline:
        "border border-slate-300 hover:bg-slate-50 text-slate-700 dark:border-slate-700 dark:hover:bg-slate-800 dark:text-slate-200 focus:ring-blue-500",
      danger:
        "bg-red-600 hover:bg-red-700 text-white shadow-sm focus:ring-red-500 dark:focus:ring-offset-slate-900",
      ghost:
